    ...
    <div className="container small">
      <div className="fn_cs_shortabout">
        <div className="about_left">
          ...
          <div className="desc">
            <p>
              Creativity and innovation are vital components of a well-rounded education. In today's fast-paced and rapidly changing world, it is essential that students learn how to think creatively and come up with innovative solutions to complex problems.

              Creativity and innovation are not just important for practical problem-solving; they are also essential for personal and intellectual growth. Engaging in creative endeavors can help students develop their imagination, curiosity, and empathy, and can give them a sense of purpose and fulfillment.
